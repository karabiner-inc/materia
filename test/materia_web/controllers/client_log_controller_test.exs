defmodule MateriaWeb.ClientLogControllerTest do
  ...
  describe "create client_log" do
    test "renders client_log when data is valid", %{conn: conn} do
      ...
      create_attrs = %{client_ip: "some client_ip", evidence_url: "some evidence_url", log_datetime: "2010-04-17 14:00:00.000000Z", routing_path: "some routing_path", trace_log: "some trace_log", user_agent: "some user_agent", user_id: 42}
