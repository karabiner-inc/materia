defmodule MateriaWeb.UserControllerTest do
  ...
  describe "admin_user" do
    test "admin user ligin cycle", %{conn: conn} do
      ...
      assert json_response(show_me_conn, 200) == %{"email" => "hogehoge@example.com", "id" => 1, "name" => "hogehoge", "role" => "admin", "addresses" => [%{"address1" => "福岡市中央区", "address2" => "大名 x-x-xx", "id" => 2,"latitud" => nil, "location" => "福岡県", "lock_version" => 0, "longitude" => nil, "organization" => [], "subject" => "billing", "user" => [], "zip_code" => "810-ZZZZ"}, %{"address1" => "福岡市中央区", "address2" => "港 x-x-xx", "id" => 1, "latitud" => nil, "location" => "福岡県", "lock_version" => 0, "longitude" => nil, "organization" => [], "subject" => "living", "user" =>[], "zip_code" => "810-ZZZZ"}], "back_ground_img_url" => nil, "descriptions" => nil, "external_user_id" => nil, "icon_img_url" => nil, "lock_version" => 2, "organization" => %{"addresses" => [], "back_ground_img_url" => "https://hogehoge.com/ib_img.jpg", "hp_url" => "https://hogehoge.inc", "id" => 1, "lock_version" => 1, "name" => "hogehoge.inc", "one_line_message" => "let's do this.", "phone_number" => nil, "profile_img_url" => "https://hogehoge.com/prof_img.jpg", "status" => 1, "users" => []}, "phone_number" => nil, "status" => 1}

      # show user list (allow anybody)
      users_conn = get conn, user_path(conn, :index)
      assert json_response(users_conn, 200) == [%{"email" => "fugafuga@example.com", "id" => 2, "name" => "fugafuga", "role" => "operator", "addresses" => [], "back_ground_img_url" => nil, "descriptions" => nil, "external_user_id" => nil, "icon_img_url" => nil, "lock_version" => 1, "organization" => nil, "phone_number" => nil, "status" => 1}, %{"email" => "hogehoge@example.com", "id" => 1, "name" => "hogehoge", "role" => "admin", "addresses" => [%{"address1" => "福岡市中央区", "address2" => "港 x-x-xx", "id" => 1, "latitud" => nil, "location" => "福岡県", "lock_version" => 0, "longitude" => nil, "organization" => [], "subject" => "living", "user" => [], "zip_code" => "810-ZZZZ"}, %{"address1" => "福岡市中央区", "address2" => "大名 x-x-xx", "id" => 2, "latitud" => nil, "location" => "福岡県", "lock_version" => 0, "longitude" => nil, "organization" => [], "subject" => "billing", "user" => [], "zip_code" => "810-ZZZZ"}], "back_ground_img_url" => nil, "descriptions" =>nil, "external_user_id" => nil, "icon_img_url" => nil, "lock_version" => 2, "organization" => %{"addresses" => [], "back_ground_img_url" => "https://hogehoge.com/ib_img.jpg", "hp_url" => "https://hogehoge.inc", "id" => 1, "lock_version" => 1, "name" => "hogehoge.inc", "one_line_message" => "let's do this.", "phone_number" => nil, "profile_img_url" => "https://hogehoge.com/prof_img.jpg", "status" => 1, "users" => []}, "phone_number" => nil, "status" => 1}]
  ...
  describe "operator_user" do
    test "operator user ligin cycle", %{conn: conn} do
      ...
      assert json_response(user_conn, 200) == %{"email" => "hogehoge@example.com", "id" => 1, "name" => "hogehoge", "role" => "admin", "addresses" => [%{"address1" => "福岡市中央区", "address2" => "大名 x-x-xx", "id" => 2,"latitud" => nil, "location" => "福岡県", "lock_version" => 0, "longitude" => nil, "organization" => [], "subject" => "billing", "user" => [], "zip_code" => "810-ZZZZ"}, %{"address1" => "福岡市中央区", "address2" => "港 x-x-xx", "id" => 1, "latitud" => nil, "location" => "福岡県", "lock_version" => 0, "longitude" => nil, "organization" => [], "subject" => "living", "user" =>[], "zip_code" => "810-ZZZZ"}], "back_ground_img_url" => nil, "descriptions" => nil, "external_user_id" => nil, "icon_img_url" => nil, "lock_version" => 2, "organization" => %{"addresses" => [], "back_ground_img_url" => "https://hogehoge.com/ib_img.jpg", "hp_url" => "https://hogehoge.inc", "id" => 1, "lock_version" => 1, "name" => "hogehoge.inc", "one_line_message" => "let's do this.", "phone_number" => nil, "profile_img_url" => "https://hogehoge.com/prof_img.jpg", "status" => 1, "users" => []}, "phone_number" => nil, "status" => 1}
  ...
  describe "user CRUD" do
    ...
    assert json_response(create_conn, 201) |> Map.delete("id") == %{"email" => "ugauga@example.com", "name" => "ugauga", "role" => "operator", "addresses" => [], "back_ground_img_url" => nil, "descriptions" => nil, "external_user_id" => nil, "icon_img_url" => nil, "lock_version" => 1, "organization" => [], "phone_number" => nil, "status" => 1}
