defmodule MateriaWeb.ValueDefinitionControllerTest do
  ...
  describe "update value_definition" do
    ...
    test "renders value_definition when data is valid", %{
      conn: conn,
      value_definition: %ValueDefinition{id: id} = value_definition
    } do
  ...
  describe "search_definitions_by_params" do
    ...
    test "definitions", %{conn: conn} do
      conn =
        post(conn, value_definition_path(conn, :list_definitions_by_params), %{
