...
{:ok, user_hogehoge} = Accounts.create_user(%{ name: "hogehoge", email: "hogehoge@example.com", password: "hogehoge", role: "admin", phonetic: "phonetic"})
Accounts.create_user(%{ name: "fugafuga", email: "fugafuga@example.com", password: "fugafuga", role: "operator", phonetic: "phonetic"})
Locations.create_address(%{user_id: user_hogehoge.id, subject: "living", location: "福岡県", zip_code: "810-ZZZZ", address1: "福岡市中央区", address2: "港 x-x-xx", address1_phonetic: "address1_phonetic", address2_phonetic: "address2_phonetic", address3_phonetic: "address3_phonetic", address3: "address3", phone_number: "phone_number", notation_org_name: "notation_org_name", notation_org_phonetic: "notation_org_phonetic", notation_name: "notation_name", notation_phonetic: "notation_phonetic"})
