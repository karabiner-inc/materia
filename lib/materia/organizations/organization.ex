defmodule Materia.Organizations.Organization do
  ...
  def changeset(organization, attrs) do
    organization
    |> cast(attrs, [:name, :hp_url, :profile_img_url, :back_ground_img_url, :one_line_message, :phone_number, :status, :lock_version, :ext_organization_id, :ext_organization_branch_id, :name_p, :fax_number])
